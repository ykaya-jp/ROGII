...
| 2026-05-11 00:13 | 52528539 | exp005 v2 | karnakbaev blend + **Edge S** (round-to-grid) | (no 自前 CV) | _PENDING_ | - | - | - | kernel: `ky7240/rogii-exp005-cache-blend` v2。subagent P 構築、Kaggle 上 COMPLETE、Edge S 単独効果測定 control。expect: 10.317 → 10.05-10.27 想定 |
